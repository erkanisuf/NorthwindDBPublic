...
namespace MVCApp.Data
{
    public partial class NorthwindDB : DbContext
    {
        ...
        public virtual DbSet<CustApu> CustApus { get; set; }
        ...
        public virtual DbSet<EmpApu> EmpApus { get; set; }
        ...
        public virtual DbSet<SuppApu> SuppApus { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustApu>(entity =>
            {
            ...
            modelBuilder.Entity<EmpApu>(entity =>
            {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasOne(d => d.Category)
                    ...
                    .HasConstraintName("FK_Products_Categories").OnDelete(DeleteBehavior.SetNull) ;

                entity.HasOne(d => d.Supplier)
                    .WithMany(p => p.Products)
                    .HasForeignKey(d => d.SupplierId)
                    .HasConstraintName("FK_Products_Suppliers").OnDelete(DeleteBehavior.SetNull);
            });
            ...
            modelBuilder.Entity<SuppApu>(entity =>
            {
